...
\}
    \end{lstlisting}
    \caption{\texttt{VerifastTest.java}}\label{fig:verifast-example}
\end{figure}
...
./VerifastTest.java(7,20-26): Target of method call might be null.
    \end{lstlisting}
    \caption{Output from analysing \texttt{VerifastTest.java}}\label{fig:verifast-example-output}
\end{figure}
...
\todo{Check and rewrite if necessary}
\polish{Some of this section has been wholly copied from a previous report; identify and replace this!}
