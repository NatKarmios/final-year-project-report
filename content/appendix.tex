...
\noindent\rule{\textwidth}{0.5pt}
\vspace{-0.6cm}
\captionof{listing}{Exerpt from the \texttt{Logging} module, showing the new functions for
...
\noindent\rule{\textwidth}{0.5pt}
\vspace{-0.6cm}
\captionof{listing}{Logging types for the interpreter, inside the \texttt{GInterpreter} module}
...
\noindent\rule{\textwidth}{0.5pt}
\vspace{-0.6cm}
\captionof{listing}{Logging types for unification, inside the \texttt{Unifier} module}
...
\noindent\rule{\textwidth}{0.5pt}
\vspace{-0.6cm}
\captionof{listing}{The required types for the \texttt{<TreeMapView />} component}
